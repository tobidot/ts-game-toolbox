...
export abstract class TestClass {
    ...
    public run_all_test_cases() {
        ...
        this.set_class_up();
        for (const test_name of Object.getOwnPropertyNames((<any>this).__proto__)) {
    ...
    public assert_instance_of<T extends Printable>(value: Printable, expected: Class<T>): void {
