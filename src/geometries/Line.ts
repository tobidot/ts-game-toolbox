...
export class Line extends Ray {
    public constructor(start: Vector2I, end: Vector2I) {
        super(start, new Vector2(end).sub(start));
    }

    public static from_points(start: Vector2I, end: Vector2I): Line {
        return new Line(
            new Vector2(start),
    ...
    public get_line_intersections(other: Ray): Array<Vector2> {
